...
df_final.to_csv(r'data\interim\phase2_append\stratified.csv', index=False)

print("Đã lọc dữ liệu thành công và xuất file 'data/interim/phase2_append/stratified.csv'!")
