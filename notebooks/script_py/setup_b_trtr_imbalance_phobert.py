...
def train_one_seed(seed: int, train_ds, val_ds, test_ds):
    ...
    save_prediction_outputs(
        df_test, test_logits, test_labels, default_preds, CFG["output_dir"],
        f"setup_b_B1_class_weight_default_seed_{seed}_real_test",
        setup_name="B1_class_weight_default", seed=seed,
        subset_name="real_test", threshold=0.5
    )
    save_prediction_outputs(
        df_test, test_logits, test_labels, threshold_preds, CFG["output_dir"],
        f"setup_b_B2_class_weight_threshold_seed_{seed}_real_test",
        setup_name="B2_class_weight_threshold", seed=seed,
        subset_name="real_test", threshold=tuned_threshold
    )
