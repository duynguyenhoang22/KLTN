...
Run from repository root:
    python data/build_phase2_full_normalization_dataset_label0.py --init
    python data/build_phase2_full_normalization_dataset_label0.py --finalize

Optional Mistral generation:
    python data/build_phase2_full_normalization_dataset_label0.py --run-mistral --limit 200 --batch-size 20
...
def write_report(working: pd.DataFrame, final: pd.DataFrame | None = None) -> None:
    ...
    lines.append("Generated by `data/build_phase2_full_normalization_dataset_label0.py`.\n\n")
    lines.append("## Output\n\n")
